...
+!start : td("https://was-course.interactions.ics.unisg.ch/wake-up-ontology#Wristband", Url) <-
    ...
    makeArtifact("wristband", "org.hyperagents.jacamo.artifacts.wot.ThingArtifact", [Url], WristbandArt);
    .print("Wristband Thing Artifact created:", WristbandArt);
...
+owner_state(State) : true <-
    ...
    .send(personal_assistant, tell, owner_state(State)); // Task 3
    .print("Personal Assistant informed that owner_state is ", State).
